...
public class Combiner extends Thread {
	...
	BufferInterface bufferIn;
	BufferInterface bufferOut;

	public Combiner(BufferInterface buffer2, BufferInterface buffer3) {
		super();
		this.bufferIn = buffer2;
		this.bufferOut = buffer3;
	}
